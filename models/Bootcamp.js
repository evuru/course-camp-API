...
const BootcampSchema = new mongoose.Schema({
    ...
    description: {
        ...
        minlength: [50,'Bootcamp description cannot be less than 50 characters'],
...
//Cascade delete bootcamp courses if bootcamp is deleted
BootcampSchema.pre("findOneAndDelete", async function(next) {
    CourseDBmodel = require('./Course');
    console.log(this._conditions._id);
    console.log(this.model);
    await CourseDBmodel.deleteMany({ bootcamp: this._conditions._id });
